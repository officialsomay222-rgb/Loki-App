    ...
    >
      ...
      <div className="p-6 space-y-8 overflow-y-auto custom-scrollbar transform-gpu" style={{ WebkitOverflowScrolling: 'touch', transform: 'translateZ(0)', willChange: 'transform' }}>
        <div className="space-y-4">
          <label htmlFor="profile-name" className="block text-[10px] font-bold text-slate-500 dark:text-[#717171] uppercase tracking-[0.2em]">Display Name</label>
          <input 
            id="profile-name"
            type="text" 
            value={tempName}
        ...
        <div className="space-y-4">
          <label htmlFor="profile-email" className="block text-[10px] font-bold text-slate-500 dark:text-[#717171] uppercase tracking-[0.2em]">Email Address</label>
          <input 
            id="profile-email"
            type="email" 
            value={tempEmail}
