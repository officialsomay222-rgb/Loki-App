...
export const generateChatResponse = async (params: {
  ...
  if (params.mode === "fast" || hasAttachments) {
    ...
    if (!apiKey) throw new Error("Google AI Key is missing. Please add it to your environment variables.");
    ...
    if (!groqKey) throw new Error("Groq API Key is missing. Please add it to your environment variables.");
